...
fn test_help_text_under_200_bytes() {
    ...
    assert!(
        ...
        main_help.len(), MAX_MESSAGE_SIZE, main_help
    );
    ...
    assert!(
        ...
        commands_help.len(), MAX_MESSAGE_SIZE, commands_help
    );
    ...
    assert!(
        ...
        movement_help.len(), MAX_MESSAGE_SIZE, movement_help
    );
    ...
    assert!(
        ...
        social_help.len(), MAX_MESSAGE_SIZE, social_help
    );
    ...
    assert!(
        ...
        bulletin_help.len(), MAX_MESSAGE_SIZE, bulletin_help
    );
    ...
    assert!(
        ...
        mail_help.len(), MAX_MESSAGE_SIZE, mail_help
    );
}
...
fn test_currency_display_under_200_bytes() {
    ...
    let decimal = CurrencyAmount::Decimal { minor_units: 123456 };
    ...
    let multi_tier = CurrencyAmount::MultiTier { base_units: 987654321 };
...
fn test_error_messages_under_200_bytes() {
    ...
    for error in errors {
        assert!(
            ...
            error.len(), MAX_MESSAGE_SIZE, error
        );
    }
}
