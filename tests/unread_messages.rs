...
async fn unread_message_count_on_login() {
    ...
    let cfg = Config {
    bbs: BbsConfig { name: "Test".into(), sysop: "sysop".into(), location: "Loc".into(), description: "Desc".into(), max_users: 10, session_timeout: 5, welcome_message: "Welcome".into(), sysop_password_hash: None, public_command_prefixes: None },
