...
async fn test_where_player_locates_others_admin_only() {
    ...
    server.test_register("moderator1", "password401").await.unwrap();
...
async fn test_where_player_not_found() {
    ...
    server.test_register("moderator2", "password601").await.unwrap();
...
async fn test_goto_room_teleports_admin() {
    ...
    server.test_register("moderator3", "password701").await.unwrap();
...
async fn test_goto_invalid_target() {
    ...
    server.test_register("moderator4", "password901").await.unwrap();
...
async fn test_monitoring_commands_all_admin_levels() {
    ...
    for level in 1..=3 {
        ...
        server.test_register(&username, "password123").await.unwrap();
